...
MEMBER_READS: dict[tuple[str, str], str] = {
    ...
    **{("GET", f"/api/v1/{r}"): "business documents are the workspace's"
       for r in (
           ...
           "sales-orders", "sales-order-items", "sales-order-adjustments", "fulfilment-backlog",
           ...
           "leads", "opportunities", "opportunity-items", "opportunity-contacts",
           "activities", "events", "event-participants", "communication-events",
           "geos", "territories", "territory-geos", "territory-members",
