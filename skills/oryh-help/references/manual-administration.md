<!-- generated from docs/manual/administration.md by the help-references sync (sync_help_references) — edit the source, not this file -->

# Administration

The console administers the workspace. It is not where the work happens — that
is daily use — but it is where you check what the work did,
...
other; set up the workspace explains why that matters.
