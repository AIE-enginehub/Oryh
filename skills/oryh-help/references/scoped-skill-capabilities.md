<!-- generated from docs/scoped-skill-capabilities.md by the help-references sync (sync_help_references) — edit the source, not this file -->
...
5. **Bundle distribution now matches the API exactly**: a `reporter` gets
   ...
   tests/test_bundles.py (`test_scoped_system_capability_gates_custom_skill_by_object_type`)
   and tests/test_skills.py (`test_skill_validation`).
...
- capabilities-skills-api.md: the big picture —
